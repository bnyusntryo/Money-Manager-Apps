package com.example.moneymanagerapps.viewmodels;
...
public class MainViewModels extends AndroidViewModel {
    ...
    public void addTransactions(){
        realm.beginTransaction();
        realm.copyToRealmOrUpdate(new Transaction(Constants.INCOME, "Allowance", "Cash", "Some Note Here", new Date(), 500, new Date().getTime()));
        realm.copyToRealmOrUpdate(new Transaction(Constants.EXPENSE, "Petty Cash", "Card", "Some Note Here", new Date(), -900, new Date().getTime()));
        realm.copyToRealmOrUpdate(new Transaction(Constants.INCOME, "Bonus", "Accounts", "Some Note Here", new Date(), 500, new Date().getTime()));
        realm.copyToRealmOrUpdate(new Transaction(Constants.TRANSFER, "Petty Cash", "Card", "Some Note Here", new Date(), 400, new Date().getTime()));
        realm.commitTransaction();
    }
